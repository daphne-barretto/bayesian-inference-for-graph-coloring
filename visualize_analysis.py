...
if __name__ == '__main__':
    ...
    csv_file = open("./data/model_comparisons/analysis_avg_solution_time.csv", "r")
    ...
    if plot_models_over_memory:
        ...
        for probability_matching_option in probability_matching_options:
            ...
            for memory_option in memory_options:
                ...
                if (i-1) % 30 == 0:
                    plt.plot(q_options, model_avg_solution_time, "o-", label=(("memory_%d")%(probability_matching_option, memory_option)))
