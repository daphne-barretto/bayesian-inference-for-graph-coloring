...
if __name__ == '__main__':
    ...
    model_location = "./data/weighted_average_models"
    ...
    for model_option in model_options:
        model_option_location = model_location + "/%s-%s-memory_%d-stubbornness_0.00_0.00-randomness_0.00_0.00-unstuckness_0.00_0.00" % (model_option[0], model_option[1], model_option[2])
    ...
    csv_file = open("./data/model_comparisons/analysis_avg_solution_time_weighted_average_180_pm.csv", "w")
