...
def run_set_of_trials_across_q(args, trials=0):
    ...
    for q in q_list:
        ...
        model_option_location = model_location + "/averaging_system-%s" % (decision_making)
        trial_location = model_option_location + "/max_iterations_%d-cliques_6-nodes_per_clique_6-colors_9-q_%.2f" % (args.max_iterations, q)
...
if __name__ == '__main__':
    ...
    # file parameters
    parser.add_argument("--model_location", type=str, default="./data/averaging_system/")
    ...
    trial_args.averaging_system = True
