...
def run_set_of_trials_across_q(args, trials=0):
    ...
    for q in q_list:
        ...
        model_option_location = model_location + "/%s-%s-transparent-memory_%d-stubbornness_0.00_0.00-randomness_0.00_0.00-unstuckness_0.00_0.00" % (decision_making_calculation, decision_making, args.memory)
...
if __name__ == '__main__':
    ...
    # file parameters
    parser.add_argument("--model_location", type=str, default="./data/transparent_models/")
    ...
    trial_args.transparent = True
    run_set_of_trials_across_q(trial_args, args.trials)

    # trial_args.memory = args.memory
    # trial_args.probability_matching = False
    # trial_args.sum = False
    # run_set_of_trials_across_q(trial_args, args.trials)
    # trial_args.memory = args.memory + 90
    # run_set_of_trials_across_q(trial_args, args.trials)

    # trial_args.memory = args.memory
    # trial_args.probability_matching = True
    # trial_args.sum = False
    # run_set_of_trials_across_q(trial_args, args.trials)
    # trial_args.memory = args.memory + 90
    # run_set_of_trials_across_q(trial_args, args.trials)
