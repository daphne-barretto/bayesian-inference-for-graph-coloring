...
if __name__ == '__main__':
    ...
    for model_option in model_options:
        ...
        for q in q_list:
            ...
            assert len(os.listdir(trial_location + "/csv/")) == 100, "%d csv files found, not 100: %s" % (len(os.listdir(trial_location + "/csv/")), trial_location)
            assert len(os.listdir(trial_location + "/animation/")) == 100, "%d gif files found, not 100: %s" % (len(os.listdir(trial_location + "/animation/")), trial_location)
            assert len(os.listdir(trial_location + "/component_plot/")) == 100, "%d png files found, not 100: %s" % (len(os.listdir(trial_location + "/component_plot/")), trial_location)
