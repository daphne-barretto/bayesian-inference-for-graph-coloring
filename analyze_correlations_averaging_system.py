...
if __name__ == '__main__':
    ...
    csv_file_read = open("./data/model_comparisons/analysis_avg_solution_time_averaging_system.csv", "r")

    reader = csv.reader(csv_file_read, delimiter=',')
    rows = list(reader)

    csv_file_write = open("./data/model_comparisons/correlations_averaging_system.csv", "w")
