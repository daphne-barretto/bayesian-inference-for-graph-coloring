...
if __name__ == '__main__':
    ...
    csv_file = open("./data/model_comparisons/analysis_avg_solution_time_weighted_average_180.csv", "r")
    ...
    probability_matching_options = ["deterministic"]
    memory_options = list(range(0, 180))
    ...
    if plot_models_over_memory:
        ...
        for probability_matching_option in probability_matching_options:
            ...
            plt.savefig("./data/model_comparisons/comparison_plots_weighted_average/comparison-%s-180.png" % (probability_matching_option))
            plt.close()
            j+= 1
